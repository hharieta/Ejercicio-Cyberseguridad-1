...
#
# En una de las revisiones descubres que hubo un acceso no autorizado a una de las carpetas 
# que contenia informacion confidencial de la empresa, de acuerdo a las politicas de seguridad de
# la empresa se tiene que evaluar la disponibilidad, confidencialidad e integridad de los archivos que hay dentro de la carpeta.
#
# Durante las evaluaciones se verifico que la informacion sigue disponible y confiencial, 
# por lo que es necesario verificar que la informacion de la empresa siga integra por lo que te asignan ese valor.
#
...
# 6d5e43a730490d75968279b6adbd79ec pass.txt 129ea0c67567301df1e1088c9069b946 plan-A.txt 
# 4e9878b1c28daf4305f17af5537f062a plan-B.txt 66bb9ec43660194bc066bd8b4d35b151 script.py
#
